...
\captionsetup[table]{labelformat=simple, labelsep=period, name=Supplementary Table}
...
Models were fit identically to the primary analysis with the addition of this covariate term. The compartment coefficient was estimated separately for CLR and DII patient groups to allow for potential group-specific compartment effects. Table~\ref{tab:compartment_effects} shows the estimated compartment effects for each target cell type and patient group.
...
\label{fig:compartment_comparison}
\end{figure}
\end{revised}
