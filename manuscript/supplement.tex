...
Complete mFPCA results for all 15 cell type pairs are provided in Figures~S[\#] ($G$-cross) and S[\#] ($L$-cross). Each figure displays group-level mean curves with $\pm 1$ SD bands for CLR (blue) and DII (orange) patients, facilitating visual comparison of marginal spatial associations across patient groups.
