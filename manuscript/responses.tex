...
Simulation evidence in Section~\ref{sec:sim_hier} and \ref{sec:sim_comparison} now demonstrates the benefits of this hierarchical approach:
...
\textbf{Response}: The introduction has been substantially revised and streamlined. Method comparisons in the introduction establish the methodological gap and motivation, while detailed comparative analysis with results is later in the manuscript (Section~\ref{sec:mfpca_comparison}).
...
\begin{enumerate}
    ...
    \textbf{Response:} Figure 5 (Detection power comparison) has been updated. The current caption is: 
