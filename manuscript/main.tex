...
for tissue architecture confounders Technical comparison with Gibbs models is provided in Supplement Section~\ref{sec:gibbs_background}. An overview of the SHADE workflow is provided in Figure~\ref{fig:summary}.
\end{revised}
