...
\begin{figure}[ht]
    ...
    \caption{Predicted spatial distributions for target cell types in a representative image (47\_B), based on the estimated conditional intensity functions. \begin{revised}\input{snippets/r1_minor_fig_caption}\end{revised}}
