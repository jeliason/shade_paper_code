...
\begin{revised}Figure~\ref{fig:sic_crc_all} shows the estimated cohort-level SICs for all source-target cell type pairs, stratified by patient group. Comparing the CLR and DII curves reveals several notable differences in spatial interaction structure. While none of these differences reach statistical significance at the 95\% credible level (i.e., simultaneous credible bands for the SICs overlap everywhere), we highlight below a subset of interactions exhibiting marked between-group differences that are consistent with known biological mechanisms.

DII patients exhibited greater clustering of CTLs around tumor cells across all spatial ranges. While this might suggest immune recognition, it may alternatively indicate ineffective or exhausted T cell responses that fail to clear tumor cells. Persistent CTL-tumor colocalization without effective cytolysis has been associated with immune dysfunction and tumor immune escape \citep{dolina_cd8_2021,raskov_cytotoxic_2021}. Similarly, DII patients showed greater attraction of granulocytes to TAMs at all distances, suggesting enhanced myeloid-myeloid interactions that may contribute to immunosuppressive networks.

In contrast, CLR patients demonstrated distinct spatial patterns. Hybrid E/M cells showed stronger attraction of CTLs at short ranges in CLR compared to DII patients. CD4+ T cells have been implicated in modulating EMT processes \citep{xie_epithelial-mesenchymal_2025,milosevic_interactions_2024}, and the proximity of CTLs to hybrid E/M cells in CLR tumors may reflect immune engagement with tumor cells undergoing phenotypic plasticity. Additionally, CLR patients exhibited greater repulsion of CTLs from CAFs at medium-to-long ranges compared to DII, and greater repulsion of memory CD4+ T cells from hybrid E/M cells at these distances. CAFs are known to mediate immune suppression via direct inhibition and establishment of physical barriers \citep{jenkins_cancer-associated_2022,freeman_cancer-associated_2020}. The stronger repulsion in CLR tumors may indicate more effective spatial segregation of immune and suppressive stromal compartments, whereas the reduced repulsion in DII could reflect barrier disruption or exclusionary mechanisms that constrain immune cell access.\end{revised}
...
We calculated AUCs per cell type and per group (Supplement Section~\ref{sec:crc_supp_figs}). All three target cell types were better predicted in CLR patients than in DII patients, though there was a relatively large amount of variability in image-level AUCs.
